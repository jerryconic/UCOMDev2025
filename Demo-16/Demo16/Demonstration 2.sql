...
INSERT INTO dbo.ProductImport 
  (ProductDetails)
  VALUES ('
<Production.Product xmlns="urn:schemas-microsoft-com:sql:SqlRowSet3" ProductID="1" Name="Adjustable Race" Color="Red" ListPrice="0.0000" />
<Production.Product xmlns="urn:schemas-microsoft-com:sql:SqlRowSet3" ProductID="2" Name="Bearing Ball" Size="Big" ListPrice="0.0000" />
');
GO
...
INSERT INTO dbo.ProductImport 
  (ProductDetails)
  VALUES ('
<Production.Product xmlns="urn:schemas-microsoft-com:sql:SqlRowSet3" ProductID="1" Name="Adjustable Race" Spec="3X4" Color="Red" ListPrice="0.0000" />
<Production.Product xmlns="urn:schemas-microsoft-com:sql:SqlRowSet3" ProductID="2" Name="Bearing Ball" Size="Big" ListPrice="0.0000" />
');
GO
...
INSERT INTO dbo.ProductImport 
  (ProductDetails)
  VALUES ('
<Production.Product xmlns="urn:schemas-microsoft-com:sql:SqlRowSet3" Name="Adjustable Race" Color="Red" ListPrice="0.0000" />
<Production.Product xmlns="urn:schemas-microsoft-com:sql:SqlRowSet3" ProductID="2" Name="Bearing Ball" Size="Big" ListPrice="0.0000" />
');
GO
